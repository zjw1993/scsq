...
layui.define(['element'], function(exports) {
	...
	Tab.prototype.init = function() {
		...
		if(typeof(_config.elem) !== 'string' && typeof(_config.elem) !== 'object') {
			...
			Admin.warning('Tab error: elem参数未定义或设置出错，具体设置格式请参考文档API.');
		}
		var $container;
	...
	Tab.prototype.tabAdd = function(data) {
		...
		if(_config.contextMenu) {
			...
			ELEM.titleBox.find('li').on('contextmenu', function(e) {
				...
				var ul = '<ul>';
				ul += '<li data-target="refresh" title="刷新当前选项卡"></i> 刷新</li>';
				ul += '<li data-target="closeCurrent" title="关闭当前选项卡"></i> 关闭当前</li>';
				ul += '<li data-target="closeOther" title="关闭其他选项卡"></i> 关闭其他</li>';
				ul += '<li data-target="closeAll" title="关闭全部选项卡"></i> 全部关闭</li>';
				ul += '</ul>';
				div.innerHTML = ul;
